...
export const KeyIcon = (props: React.SVGProps<SVGSVGElement>) => ( // Change Password Icon
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M15.75 1.5a6.75 6.75 0 0 0-6.655 5.263l- торговель-1.381.776 1.38 2.485.708-.393a4.502 4.502 0 0 1 8.013 4.418l1.38-2.485-.707-.393a6.75 6.75 0 0 0-1.74-9.664ZM12.25 18a3.25 3.25 0 1 0 0-6.5 3.25 3.25 0 0 0 0 6.5Z" clipRule="evenodd" />
    <path d="M10.828 10.828a1.5 1.5 0 0 1 .168-1.996l2.25-2.25a1.5 1.5 0 1 1 2.122 2.121l-2.25 2.25a1.5 1.5 0 0 1-1.996.168Zm.872 3.03a1.5 1.5 0 0 1-2.274 1.906l-2.25 2.25a1.5 1.5 0 0 1-2.121-2.121l2.25-2.25a1.5 1.5 0 0 1 1.906-2.274A4.478 4.478 0 0 0 9 13.5a4.5 4.5 0 0 0 2.7 4.102Z" />
  </svg>
);
